        ...
        <div class="card-body">
            <div class="d-flex">
                ...
                <div class="col-10 d-flex">
                    ...
                    <a href="{{ route('anomalies.create') }}" class="btn"><i class="align-middle text-success fa-solid fa-square-plus" title="Crear nueva Anomalía"></i></a>
                </div>
            </div>
        </div>
    </div>
